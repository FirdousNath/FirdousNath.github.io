...
function populateBlogs(items, id) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    blogTitle.style = "margin: 0 0 8px; font-size: 18px; font-weight: bold; color: #fff;";
    ...
    pubDateEle.style = "margin: 0 0 12px; font-size: 12px; color: rgba(255,255,255,0.8);";
    ...
    blogDescription.style = "margin: 0 0 12px; font-size: 12px; color: rgba(255,255,255,0.9);";
    ...
    for (const category of items[i].categories) {
      ...
      badge.style = `
              font-size: 12px;
              padding: 4px 8px;
              background-color: rgba(46, 7, 63, 0.3);  /* #2E073F with 0.3 opacity */
              color: white;
              border-radius: 10px;
          `;
...
function populateRepo(items, id) {
  const projectdesign = document.getElementById(id);
  const count = 3; // Adjust this count based on the number of repos you want to display
  ...
  for (let i = 0; i < count; i++) {
    ...
    repoName.style = "margin: 0; font-size: 18px; font-weight: bold; color: #fff;";
    ...
    repoDescription.style = "margin-top: 8px; font-size: 12px; color: rgba(255,255,255,0.8);";
    ...
    languageDiv.innerHTML = `
          <span style="width: 8px; height: 8px; background-color: #fff; border-radius: 50%; display: inline-block;"></span>
          ${items[i].language}
      `;
